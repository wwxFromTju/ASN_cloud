...
# 由于显存的大小区别，分类map
same_type_map = {
    'small': ["3m", "3s_vs_3z", "3s_vs_4z", "3s_vs_5z", "5m_vs_6m"], # "2m_vs_1z" ,"2s_vs_1sc"
...
while len(map_scale[FLAGS.map_type][FLAGS.map_size]) != 0:
    ...
    task = subprocess.Popen(["CUDA_VISIBLE_DEVICES='{}' python src/main.py --config=qmix --env-config=sc2 with env_args.map_name={} agent='{}' asn_hidden_size=32 t_max=2050000 env=sc2_full_action".format(FLAGS.gpu_index, map_name, FLAGS.agent_type)], shell=True)
